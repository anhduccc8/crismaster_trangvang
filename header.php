...
<?php
$menu_items = wp_get_menu_array('30');
            ...
            <div class="container">
                <div class="row">
                    <div class="hidden-md-up text-sm-center header_mobile_sticky mobile">
                        ...
                        <div class="top-logo" id="_mobile_contact_link">
                            <div id="contact-link">
                                                            ...
                                                            <ul class="prmn_menus_ul auto">
                                                                ...
                                                                <?php if (!empty($menu_items)){
                                                                    foreach ($menu_items as $menu) { ?>
                                                                        <li class="prmn_menus_li prmn_sub_align_auto id-<?= $menu['ID'] ?> <?php if (!empty($menu['children'])){ echo 'prmn_has_sub'; } ?>">
                                                                            <a href="<?= $menu['url'] ?>" style="">
                                                                                <?php if ($menu['title'] == 'Khuyến mại'){ ?>
                                                                                    <span class="prmn_menu_content_title">
                                                                                    <i class="ets_svg"><svg width="1792" height="1792" viewBox="0 0 1792 1792" xmlns="http://www.w3.org/2000/svg"><path d="M1472 896q0-117-45.5-223.5t-123-184-184-123-223.5-45.5-223.5 45.5-184 123-123 184-45.5 223.5 45.5 223.5 123 184 184 123 223.5 45.5 223.5-45.5 184-123 123-184 45.5-223.5zm276 277q-4 15-20 20l-292 96v306q0 16-13 26-15 10-29 4l-292-94-180 248q-10 13-26 13t-26-13l-180-248-292 94q-14 6-29-4-13-10-13-26v-306l-292-96q-16-5-20-20-5-17 4-29l180-248-180-248q-9-13-4-29 4-15 20-20l292-96v-306q0-16 13-26 15-10 29-4l292 94 180-248q9-12 26-12t26 12l180 248 292-94q14-6 29 4 13 10 13 26v306l292 96q16 5 20 20 5 16-4 29l-180 248 180 248q9 12 4 29z"/></svg></i>
                                                                                Khuyến mại
                                                                                <span class="prmn_bubble_text"style="background: #cf0007; color: #ffffff;">Sale</span> </span>
                                                                                <?php }else{ ?>
                                                                                    <span class="prmn_menu_content_title"> <?= $menu['title'] ?>
                                                                            ...
                                                                            <?php if (!empty($menu['children'])){ ?>
                                                                                ...
                                                                                <ul class="prmn_columns_ul" style="  width:100%; " >
                                                                                    <?php foreach ($menu['children'] as $child1){ ?>
                                                                                        <li class="prmn_columns_li column_size_2 id-<?= $child1['ID'] ?>  <?php if (!empty($child1['children'])){ echo 'prmn_has_sub'; } ?>">
                                                                                            <ul class="prmn_blocks_ul">
                                                                                                <li data-id-block="29" class="prmn_blocks_li">
                                                                                                    <div class="ets_prmn_block prmn_block_type_category ">
                                                                                                        <span class="h4" style="text-transform: uppercase; border-bottom: 1px solid #e7e7e7;"><?= $child1['title'] ?></span>
                                                                                                        <div class="ets_prmn_block_content">
                                                                                                            <ul class="ets_prmn_categories">
                                                                                                                <?php if (!empty($child1['children'])){
                                                                                                                    foreach ($child1['children'] as $child2){ ?>
                                                                                                                        <li >
                                                                                                                            <a href="<?= $child2['url'] ?>"><?= $child2['title'] ?></a>
                                                                                                                        </li>
                                                                                                                    <?php }
                                                                                                                } ?>
                                                                                                            </ul>
