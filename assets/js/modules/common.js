var wScreen = $(window).width(),
    ...
    CRISMASTER = {
        init: function() {
            CRISMASTER.global.OpenSubmenu(), CRISMASTER.global.OpenMenu(), CRISMASTER.global.bannerHome(), CRISMASTER.global.crsCate(), CRISMASTER.global.scrollPage(), CRISMASTER.global.subMenuPage(), setTimeout(function() {
                CRISMASTER.global.detectMaxHeight()
            }, 500), $(window).resize(function(e) {
                CRISMASTER.global.detectMaxHeight()
            }), $(".loading").fadeOut(function() {
                $(window).innerWidth() > 767 && CRISMASTER.global.animationScroll()
            }), $(".nano").nanoScroller()
        }
    };
CRISMASTER.global = {
    ...
    bannerHome: function() {
        ...
        e.on("beforeChange", function(e, a, t, i) {}), e.on("afterChange", function(e, a, t, i) {
            $(".hasVideo").html(""), CRISMASTER.global.addVideo()
        })
    },
    addVideo: function() {
    ...
    OpenMenu: function() {
        $(".hamburger-menu").on("click", function() {
            $(".ctMenu").hasClass("active") ? ($(".hdContainer,.ctMenu").removeClass("active"), $(".bar").removeClass("animate"), $(".ctMenu").fadeOut()) : ($(".bar").addClass("animate"), $(".hdContainer,.ctMenu").addClass("active"), CrisMaster.set($("#nav > li,.subLink a"), {
                x: -50,
                autoAlpha: 0
            }), $(".ctMenu").fadeIn(function() {
                CrisMaster.staggerTo($("#nav > li,.subLink a"), 1, {
                    x: 0,
                    autoAlpha: 1,
                    ease: Power4.easeOut
                }, .1)
    ...
    OpenSubmenu: function() {
        $("#nav > li").hover(function() {
            $(window).innerWidth() > 767 && ($(this).find(".submenu").show(), $(this).find(".submenu").addClass("active"), CrisMaster.set($(this).find(".submenu"), {
                x: -50,
                autoAlpha: 0
            }), CrisMaster.set($(this).find(".submenu a"), {
                x: -30,
                autoAlpha: 0
            }), CrisMaster.to($(this), 1, {
                x: 25,
                // ease: Power2.easeOut
            }), CrisMaster.to($(this).find(".submenu"), 1, {
                x: 0,
                autoAlpha: 1,
                // ease: Power2.easeOut
            }), CrisMaster.staggerTo($(this).find(".submenu a"), 1, {
                x: 0,
                autoAlpha: 1,
                // ease: Power4.easeOut
            }, .1))
        }, function() {
            $(window).innerWidth() > 767 && (CrisMaster.staggerTo($(".submenu.active,.submenu.actives a"), 1, {
                x: -50,
                autoAlpha: 0,
                // ease: Power4.easeOut
            }, .1), $(this).find(".submenu.active").removeClass("active"), CrisMaster.to($("#nav > li"), 1, {
                x: 0,
                // ease: Power2.easeOut
            }))
        })
    ...
    animationScroll: function() {
        ...
        CrisMaster.set($("#itemPageWrap ul li"), {
            y: 200,
            autoAlpha: 0
        });
        new ScrollMagic.Scene({
            ...
            CrisMaster.staggerTo($("#itemPageWrap ul li"), 1.5, {
                y: 0,
                autoAlpha: 1,
                ease: Power4.easeOut
            }, .2)
        }).addTo(o);
        CrisMaster.set($(".partnertPd ul li"), {
            y: 200,
            autoAlpha: 0
        });
        new ScrollMagic.Scene({
            ...
            CrisMaster.staggerTo($(".partnertPd ul li"), 1.5, {
                y: 0,
                autoAlpha: 1,
                ease: Power4.easeOut
            }, .2)
