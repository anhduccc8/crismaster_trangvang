...
if(function_exists('vc_map')){
    vc_map(array(
        'name' => esc_html__($pre_text.'Có thể bạn thích','crismaster'),
        'base' => 'co_the_ban_thich',
        'class' => '',
        'icon' => 'icon-st',
        'category' => 'Content',
        'params' => array(
            array(
                ...
                'params' => array(
                    ...
                    array(
                        'type' => 'textfield',
                        'heading' => esc_html__('Giá cũ','crismaster'),
                        'param_name' => 'price_old',
                        'value' => '',
                        'description' => esc_html__('Giá cũ sẽ được hiển thị gạch bỏ',"crismaster")
                    ),
                    array(
                        'type' => 'textfield',
...
add_shortcode('co_the_ban_thich','co_the_ban_thich_func');
function co_the_ban_thich_func($atts,$content = null){
                ...
                <div class="home-position col-lg-12 col-sm-12 col-md-12 col-xs-12">
                    <div class="tea_categories_group tea_cat_17 center enable_css16">
                        <div class="tea_adc_heading">
                            <h3 class="tea_adc_title">Có Thể Bạn Thích</h3>
                            <p class="tea_adc_subtitle"></p>
                        </div>
                        <div class="tea_blocks_wrapper slider">
                            <div class="tea_block_product_item item16 cat3 active">
                                <div class="tea_block_product tea_catblock_17 slides-co-the-ban-thich owl-carousel">
                                                ...
                                                <div class="thumbnail-container">
                                                    ...
                                                    <div class="product-description">
                                                        ...
                                                        <div class="product-price-and-shipping">
                                                             <?php   if(isset($dca['price_old']) && $dca['price_old'] != '') { ?>
                                                                 <span class="regular-price" aria-label="Giá"><?= $dca['price_old'] ?></span>
                                                            <?php   }
                                                            if(isset($dca['price_lh']) && $dca['price_lh'] = true) { ?>
