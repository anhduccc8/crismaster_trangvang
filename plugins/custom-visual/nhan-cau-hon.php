...
if(function_exists('vc_map')){
    vc_map(array(
        'name' => esc_html__($pre_text.'Nhẫn cầu hôn','crismaster'),
        'base' => 'nhan_cau_hon',
        'class' => '',
        'icon' => 'icon-st',
        'category' => 'Content',
...
add_shortcode('nhan_cau_hon','nhan_cau_hon_func');
function nhan_cau_hon_func($atts,$content = null){
                ...
                <div class="home-position col-lg-12 col-sm-12 col-md-12 col-xs-12">
                    <div class="tea_categories_group tea_cat_17 center enable_css16">
                        <div class="tea_adc_heading">
                            <h3 class="tea_adc_title">Nhẫn Cầu Hôn</h3>
                            <p class="tea_adc_subtitle"></p>
                        </div>
                        <div class="tea_categories group5" >
                            <div class="tea_blocks_wrapper slider"">
                                <div class="tea_block_product_item item28 cat39 active">
                                    <div class="tea_block_product tea_catblock_17 slides-nhan-cau-hon owl-carousel" >
                                                ...
                                                <article class="product-miniature js-product-miniature">
                                                    <div class="thumbnail-container">
                                                        ...
                                                        <div class="product-description">
                                                            <h3 class="h3 product-title" title="<?php echo ($dca['title_ca']); ?>"><a href="<?php echo esc_url($dca['link_ca']); ?>" ><?php echo strlen($dca['title_ca']) > 30 ? mb_substr($dca['title_ca'],0,30,'utf-8')."..." : $dca['title_ca']; ?></a></h3>
