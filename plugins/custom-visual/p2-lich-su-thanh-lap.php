...
function lich_su_thanh_lap_func($atts,$content = null){
    ...
    $mobile = wp_is_mobile();
    ?>
    <section class="section shs-section-widget bg-img-section shs-section-history" id="p2-lich-su-thanh-lap lich-su-thanh-lap" data-anchor="lich-su-thanh-lap" style="background-image: url('<?= get_template_directory_uri() ?>/assets/images/bgr-section-history.jpg');">
