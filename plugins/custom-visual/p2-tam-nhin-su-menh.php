...
function p2_tam_nhin_su_menh_func($atts,$content = null){
    ...
    $mobile = wp_is_mobile();
    ?>
    <section class="shs-section-widget bg-img-section shs-section-about-03" style="background-image: url('<?= get_template_directory_uri() ?>/assets/images/bgr-section-03.jpg');">
