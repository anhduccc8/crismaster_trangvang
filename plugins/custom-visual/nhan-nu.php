...
if(function_exists('vc_map')){
    vc_map(array(
        'name' => esc_html__($pre_text.'Nhẫn nữ','crismaster'),
        'base' => 'nhan_nu',
        'class' => '',
        'icon' => 'icon-st',
        'category' => 'Content',
...
add_shortcode('nhan_nu','nhan_nu_func');
function nhan_nu_func($atts,$content = null){
                ...
                <div class="home-position col-lg-12 col-sm-12 col-md-12 col-xs-12">
                    <div class="tea_categories_group tea_cat_17 center enable_css16">
                        <div class="tea_adc_heading">
                            <h3 class="tea_adc_title">Nhẫn Nữ</h3>
                            <p class="tea_adc_subtitle"></p>
                        </div>
                        <div class="tea_categories group8" data-group="8">
                            <div class="tea_blocks_wrapper slider">
                                <div class="tea_block_product_item item4 cat82 active">
                                    <div class="tea_block_product tea_catblock_17 slides-nhan-nu owl-carousel" >
